# ------------------------------------------------------------
# solve_inequality_periodic_z.R
# Solve for z where: 273.15 > Ts*exp(-k*z) - (A/b)*exp(-z/d)*sin((pi*month/6) - (z/d) + p)
# i.e., f(z) = Ts*exp(-k*z) - (A/b)*exp(-z/d)*sin((pi*month/6) - (z/d) + p) - 273.15 < 0
#
# Defaults: k = 0.00331, d = 1.06, b = 2.25
# ------------------------------------------------------------
...
#----Sample ALT Solution -----------
setwd("C:/Users/mgaribal/Documents/Sample_Script")
gParameters = fread("gParameters.csv")
siteInfo = fread("siteInfo.csv")
...
ALTparameters <- ALTparameters[!is.na(roots)]
